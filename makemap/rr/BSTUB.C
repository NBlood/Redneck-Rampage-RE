...
char *Help3d[MAXHELP3D]=
    ...
    {" ' DEL = CSTAT=0"},
    {" ' K = SCALE SPRITE TO RUNTIME SIZE"},
        };
...
void PutScale(int spritenum)
{
    switch (sprite[spritenum].picnum)
    {
        case 60:
            sprite[spritenum].xrepeat = 11;
            sprite[spritenum].yrepeat = 12;
            break;
        case 56:
            sprite[spritenum].xrepeat = 19;
            sprite[spritenum].yrepeat = 16;
            break;
        case 40:
            sprite[spritenum].xrepeat = 9;
            sprite[spritenum].yrepeat = 9;
            break;
        case 51:
            sprite[spritenum].xrepeat = 8;
            sprite[spritenum].yrepeat = 5;
            break;
        case 21:
            sprite[spritenum].xrepeat = 16;
            sprite[spritenum].yrepeat = 16;
            break;
        case 57:
            sprite[spritenum].xrepeat = 8;
            sprite[spritenum].yrepeat = 6;
            break;
        case 52:
            sprite[spritenum].xrepeat = 13;
            sprite[spritenum].yrepeat = 9;
            break;
        case 55: //
            sprite[spritenum].xrepeat = 13;
            ...
            break;
        case 49:
            sprite[spritenum].xrepeat = 18;
            sprite[spritenum].yrepeat = 17;
            break;
        case 53:
            sprite[spritenum].xrepeat = 8;
            sprite[spritenum].yrepeat = 8;
            break;
        case 22:
            sprite[spritenum].xrepeat = 32;
            sprite[spritenum].yrepeat = 32;
            break;
        case 61: //
            sprite[spritenum].xrepeat = 32;
            sprite[spritenum].yrepeat = 32;
        ...
        case 23:
            sprite[spritenum].xrepeat = 16;
            sprite[spritenum].yrepeat = 14;
            break;
        case 24:
            sprite[spritenum].xrepeat = 17;
            sprite[spritenum].yrepeat = 16;
            break;
        case 25:
            sprite[spritenum].xrepeat = 22;
            sprite[spritenum].yrepeat = 13;
            break;
        case 26:
            sprite[spritenum].xrepeat = 9;
            sprite[spritenum].yrepeat = 9;
        ...
        case 29:
            ...
            break;
        case 32:
            sprite[spritenum].xrepeat = 10;
            sprite[spritenum].yrepeat = 9;
            break;
        case 41:
            sprite[spritenum].xrepeat = 15;
            sprite[spritenum].yrepeat = 15;
            break;
        case 42:
            sprite[spritenum].xrepeat = 10;
            sprite[spritenum].yrepeat = 9;
            break;
        case 43:
            sprite[spritenum].xrepeat = 12;
            sprite[spritenum].yrepeat = 7;
            break;
        case 47:
            sprite[spritenum].xrepeat = 32;
            sprite[spritenum].yrepeat = 32;
        ...
        case 4162:
        case 4163:
            //sprite[spritenum].xrepeat = 25;
            //sprite[spritenum].yrepeat = 21;
            //break;
        case 4249:
            sprite[spritenum].xrepeat = 25;
            sprite[spritenum].yrepeat = 21;
        ...
        case 5376:
        case 5377:
            sprite[spritenum].xrepeat = 24;
            sprite[spritenum].yrepeat = 18;
            break;
        case 5317:
            sprite[spritenum].xrepeat = 32;
            sprite[spritenum].yrepeat = 32;
        ...
        case 4983:
            ...
            break;
        case 5015:
            sprite[spritenum].xrepeat = 48;
            sprite[spritenum].yrepeat = 48;
            break;
        case 4352:
            sprite[spritenum].xrepeat = 20;
            sprite[spritenum].yrepeat = 20;
            break;
        case 1930:
            sprite[spritenum].xrepeat = 64;
            sprite[spritenum].yrepeat = 64;
            break;
        case 5635:
            sprite[spritenum].xrepeat = 22;
            sprite[spritenum].yrepeat = 20;
...
// Show2dText("sthelp.hlp");
    int updown;
    int pixels;
    sprintf(tempbuf, "Current sector %d", sectnum);
    printmessage16(tempbuf);
    updown=getnumber16("Enter floor (1)up or (2)down ", 0L, 65536L);
    if (updown == 1)
    {
        pixels = getnumber16("Enter pixels up : ", 0L, 65536L);
        pixels *= -1;
        sector[sectnum].floorz += pixels << 10;
    }
    else if (updown == 2)
    {
        pixels = getnumber16("Enter pixels dn : ", 0L, 65536L);
        sector[sectnum].floorz += pixels << 10;
    }
    updown=getnumber16("Enter ceiling (1)up or (2)down ", 0L, 65536L);
    if (updown == 1)
    {
        pixels = getnumber16("Enter pixels up : ", 0L, 65536L);
        pixels *= -1;
        sector[sectnum].ceilingz += pixels << 10;
    }
    else if (updown == 2)
    {
        pixels = getnumber16("Enter pixels dn : ", 0L, 65536L);
    ...
    sprintf(tempbuf, "floorz %ld ceilingz %ld", sector[sectnum].floorz, sector[sectnum].ceilingz);
    printmessage16(tempbuf);
...
//            case 1: case 2: sector[searchsector].cstat = 0; break;
 ...
 if (keystatus[0x28] == 1 && keystatus[0x25] == 1)
 {
     keystatus[0x25] = 0;
     if (searchstat == 3)
         PutScale(searchwall);
...
*/
 ...
 { keystatus[0x02]=0; on2d3d=!on2d3d;
 }
...
void ExtInit(void)
{
    ...
    printf("\n");
    printf("Xatrix version 1.0\n");
    printf("\n");
    printf("Customized for Interplay and Xatrix\n");
    printf("\n");
    printf("------------------------------------------------------------------------------\n");
    getch();
...
//                else tspr->cstat&=32767;
        ...
        if(frames==7) tspr->picnum+=(((totalclock>>6)%7))*5;
        if(frames==8) tspr->picnum+=(((totalclock>>6)&7))*5;
...
void Ver()
{
 sprintf(tempbuf,"REDNECK RAMPAGE BUILD: VSEP161996");
 if (qsetmode == 200)    //In 3D mode
